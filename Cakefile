...
project.name = 'MKHXCTRequirement'
project.class_prefix = 'RXCT'
...
target do |target|
    ...
    target.all_configurations.each do |configuration|
        ...
        # workaround to allow include XCTest outside of a unit test target
        configuration.settings['OTHER_LDFLAGS'] = '-weak-lswiftXCTest -weak_framework "XCTest"'
